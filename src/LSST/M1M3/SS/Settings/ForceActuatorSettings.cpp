...
void ForceActuatorSettings::load(const std::string &filename) {
    ...
    this->NetAberrationForceTolerance = boost::lexical_cast<float>(
    ...
    this->NetActiveOpticForceTolerance = boost::lexical_cast<float>(
