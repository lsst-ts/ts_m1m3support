...
void ILC::calculateHPMirrorForces() {
    ...
    _hardpointActuatorData->fz = m[12] * force[0] + m[13] * force[1] + m[14] * force[2] +
                                      m[15] * force[3] + m[16] * force[4] + m[17] * force[5];
    _hardpointActuatorData->mx = m[18] * force[0] + m[19] * force[1] + m[20] * force[2] +
                                      m[21] * force[3] + m[22] * force[4] + m[23] * force[5];
    _hardpointActuatorData->my = m[24] * force[0] + m[25] * force[1] + m[26] * force[2] +
                                      m[27] * force[3] + m[28] * force[4] + m[29] * force[5];
    _hardpointActuatorData->mz = m[30] * force[0] + m[31] * force[1] + m[32] * force[2] +
                                      m[33] * force[3] + m[34] * force[4] + m[35] * force[5];
    _hardpointActuatorData->forceMagnitude =
            sqrt(_hardpointActuatorData->fx * _hardpointActuatorData->fx +
...
void ILC::calculateFAMirrorForces() {
    ForcesAndMoments fm = ForceConverter::calculateForcesAndMoments(
            ...
            _forceActuatorData->xForce, _forceActuatorData->yForce,
            _forceActuatorData->zForce);
...
void ILC::_writeBusList(IBusList* busList) {
    ...
    _responseParser.incExpectedResponses(busList->getExpectedFAResponses(),
