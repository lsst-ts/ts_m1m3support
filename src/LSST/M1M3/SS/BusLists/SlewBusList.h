...
#ifndef SLEWBUSLIST_H_
#define SLEWBUSLIST_H_
...
class SlewBusList : public BusList {
public:
    SlewBusList(ILCSubnetData* subnetData, ILCMessageFactory* ilcMessageFactory);
