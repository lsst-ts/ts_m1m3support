...
public:
  ...
  virtual States::Type
  pauseM1M3RaisingLowering(PauseM1M3RaisingLoweringCommand *command);
  virtual States::Type
  resumeM1M3RaisingLowering(ResumeM1M3RaisingLoweringCommand *command);
  virtual States::Type
  applyActiveOpticForces(ApplyActiveOpticForcesCommand *command);
  virtual States::Type
  clearActiveOpticForces(ClearActiveOpticForcesCommand *command);
  ...
  virtual States::Type
  moveHardpointActuators(MoveHardpointActuatorsCommand *command);
  virtual States::Type
  enableHardpointChase(EnableHardpointChaseCommand *command);
  virtual States::Type
  disableHardpointChase(DisableHardpointChaseCommand *command);
  ...
  virtual States::Type
  storeTMAElevationSample(TMAElevationSampleCommand *command);
  ...
  virtual States::Type
  enableHardpointCorrections(EnableHardpointCorrectionsCommand *command);
  virtual States::Type
  disableHardpointCorrections(DisableHardpointCorrectionsCommand *command);
  virtual States::Type
  runMirrorForceProfile(RunMirrorForceProfileCommand *command);
  ...
  virtual States::Type
  forceActuatorBumpTest(ForceActuatorBumpTestCommand *command);
  virtual States::Type
  killForceActuatorBumpTest(KillForceActuatorBumpTestCommand *command);
  virtual States::Type
  disableForceActuator(DisableForceActuatorCommand *command);
  virtual States::Type enableForceActuator(EnableForceActuatorCommand *command);
  virtual States::Type
  enableAllForceActuators(EnableAllForceActuatorsCommand *command);
  virtual States::Type
  enableDisableForceComponent(EnableDisableForceComponentCommand *command);
  virtual States::Type
  setSlewControllerSettings(SetSlewControllerSettingsCommand *command);
...
protected:
  ...
  static constexpr int32_t ILC_WAIT = 20;
};
