...
#ifndef PAUSEDRAISINGENGINEERINGSTATE_H_
#define PAUSEDRAISINGENGINEERINGSTATE_H_
 ...
 */
class PausedRaisingEngineeringState : public EngineeringState {
public:
...
#endif /* PAUSEDRAISINGENGINEERINGSTATE_H_ */
