...
class M1M3SSPublisher {
   ...
   public:
    ...
    MTM1M3_logevent_appliedAberrationForcesC* getEventAppliedAberrationForces() { return &this->eventAppliedAberrationForces; }
    MTM1M3_logevent_appliedAccelerationForcesC* getEventAppliedAccelerationForces() { return &this->eventAppliedAccelerationForces; }
    MTM1M3_logevent_appliedActiveOpticForcesC* getEventAppliedActiveOpticForces() { return &this->eventAppliedActiveOpticForces; }
    MTM1M3_logevent_appliedAzimuthForcesC* getEventAppliedAzimuthForces() { return &this->eventAppliedAzimuthForces; }
    MTM1M3_logevent_appliedBalanceForcesC* getEventAppliedBalanceForces() { return &this->eventAppliedBalanceForces; }
    ...
    MTM1M3_logevent_appliedThermalForcesC* getEventAppliedThermalForces() { return &this->eventAppliedThermalForces; }
    ...
    MTM1M3_logevent_hardpointActuatorWarningC* getEventHardpointActuatorWarning() { return &this->eventHardpointActuatorWarning; }
    ...
    MTM1M3_logevent_rejectedActiveOpticForcesC* getEventRejectedActiveOpticForces() { return &this->eventRejectedActiveOpticForces; }
    MTM1M3_logevent_rejectedAzimuthForcesC* getEventRejectedAzimuthForces() { return &this->eventRejectedAzimuthForces; }
    MTM1M3_logevent_rejectedBalanceForcesC* getEventRejectedBalanceForces() { return &this->eventRejectedBalanceForces; }
    MTM1M3_logevent_rejectedCylinderForcesC* getEventRejectedCylinderForces() { return &this->eventRejectedCylinderForces; }
    MTM1M3_logevent_rejectedElevationForcesC* getEventRejectedElevationForces() { return &this->eventRejectedElevationForces; }
    MTM1M3_logevent_rejectedForcesC* getEventRejectedForces() { return &this->eventRejectedForces; }
    MTM1M3_logevent_rejectedOffsetForcesC* getEventRejectedOffsetForces() { return &this->eventRejectedOffsetForces; }
    MTM1M3_logevent_rejectedStaticForcesC* getEventRejectedStaticForces() { return &this->eventRejectedStaticForces; }
