...
void DisplacementSensorSettings::load(const std::string& filename) {
    ...
    this->N3Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N3Port").node().child_value());
    this->N4Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N4Port").node().child_value());
    this->N5Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N5Port").node().child_value());
    this->N6Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N6Port").node().child_value());
    this->N7Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N7Port").node().child_value());
    this->N8Port = boost::lexical_cast<int32_t>(doc.select_node("//DisplacementSensorSettings/N8Port").node().child_value());
    this->N1Offset = boost::lexical_cast<double>(doc.select_node("//DisplacementSensorSettings/N1Offset").node().child_value());
    this->N2Offset = boost::lexical_cast<double>(doc.select_node("//DisplacementSensorSettings/N2Offset").node().child_value());
    this->N3Offset = boost::lexical_cast<double>(doc.select_node("//DisplacementSensorSettings/N3Offset").node().child_value());
    this->N4Offset = boost::lexical_cast<double>(doc.select_node("//DisplacementSensorSettings/N4Offset").node().child_value());
    this->N5Offset = boost::lexical_cast<double>(doc.select_node("//DisplacementSensorSettings/N5Offset").node().child_value());
