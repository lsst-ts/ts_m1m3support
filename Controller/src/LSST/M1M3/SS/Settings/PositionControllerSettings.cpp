...
void PositionControllerSettings::load(const std::string &filename) {
	...
	this->ReferencePositionEncoder1 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP1Encoder").node().child_value());
	this->ReferencePositionEncoder2 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP2Encoder").node().child_value());
	this->ReferencePositionEncoder3 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP3Encoder").node().child_value());
	this->ReferencePositionEncoder4 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP4Encoder").node().child_value());
	this->ReferencePositionEncoder5 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP5Encoder").node().child_value());
	this->ReferencePositionEncoder6 = boost::lexical_cast<int32_t>(doc.select_node("//PositionControllerSettings/ReferencePosition/HP6Encoder").node().child_value());
}
