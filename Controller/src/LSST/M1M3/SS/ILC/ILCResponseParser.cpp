                ...
                if (subnet >= 1 && subnet <= 5) {
                    ...
                    switch (map.Type) {
                        case ILCTypes::FA:
                            ...
                            switch (function) {
                                case 17:
                                    this->parseReportFAServerIDResponse(buffer, map);
                                    break;
                                case 18:
                                    this->parseReportFAServerStatusResponse(buffer, map);
                                    break;
                                case 65:
                                    this->parseChangeFAILCModeResponse(buffer, map);
                                    break;
                                case 73:
                                    this->parseSetBoostValveDCAGainsResponse(buffer, map);
                                    break;
                                case 74:
                                    this->parseReadBoostValveDCAGainsResponse(buffer, map);
                                    break;
                                case 75:
                                    this->parseForceDemandResponse(buffer, address, map);
                                    break;
                                case 76:
                                    this->parsePneumaticForceStatusResponse(buffer, address, map);
                                    break;
                                case 80:
                                    this->parseSetFAADCScanRateResponse(buffer, map);
                                    break;
                                case 81:
                                    this->parseSetFAADCChannelOffsetAndSensitivityResponse(buffer, map);
                                    break;
                                case 107:
                                    this->parseFAResetResponse(buffer, map);
                                    break;
                                case 110:
                                    this->parseReadFACalibrationResponse(buffer, map);
                                    break;
                                case 119:
                                    this->parseReadDCAPressureValuesResponse(buffer, map);
                                    break;
                                case 120:
                                    this->parseReportDCAIDResponse(buffer, map);
                                    break;
                                case 121:
                                    this->parseReportDCAStatusResponse(buffer, map);
                                    break;
                                case 145:
                                case 146:
                                case 193:
                                ...
                                case 248:
                                case 249:
                                    this->parseFAErrorResponse(buffer, timestamp, map.ActuatorId);
                                    break;
                                default:
                        ...
                        case ILCTypes::HP:
                            ...
                            switch (function) {
                                case 17:
                                    this->parseReportHPServerIDResponse(buffer, map);
                                    break;
                                case 18:
                                    this->parseReportHPServerStatusResponse(buffer, map);
                                    break;
                                case 65:
                                    this->parseChangeHPILCModeResponse(buffer, map);
                                    break;
                                case 66:
                                    this->parseStepMotorResponse(buffer, map, timestamp);
                                    break;
                                case 67:
                                    this->parseElectromechanicalForceAndStatusResponse(buffer, map);
                                    break;
                                case 80:
                                    this->parseSetHPADCScanRateResponse(buffer, map);
                                    break;
                                case 81:
                                    this->parseSetHPADCChannelOffsetAndSensitivityResponse(buffer, map);
                                    break;
                                case 107:
                                    this->parseHPResetResponse(buffer, map);
                                    break;
                                case 110:
                                    this->parseReadHPCalibrationResponse(buffer, map);
                                    break;
                                case 145:
                                case 146:
                                case 193:
                                ...
                                case 235:
                                case 238:
                                    this->parseHPErrorResponse(buffer, timestamp, map.ActuatorId);
                                    break;
                                default:
                        ...
                        case ILCTypes::HM:
                            ...
                            switch (function) {
                                case 17:
                                    this->parseReportHMServerIDResponse(buffer, map);
                                    break;
                                case 18:
                                    this->parseReportHMServerStatusResponse(buffer, map);
                                    break;
                                case 65:
                                    this->parseChangeHMILCModeResponse(buffer, map);
                                    break;
                                case 107:
                                    this->parseHMResetResponse(buffer, map);
                                    break;
                                case 119:
                                    this->parseReadHMPressureValuesResponse(buffer, map);
                                    break;
                                case 120:
                                    this->parseReportHMMezzanineIDResponse(buffer, map);
                                    break;
                                case 121:
                                    this->parseReportHMMezzanineStatusResponse(buffer, map);
                                    break;
                                case 122:
                                    this->parseReportLVDTResponse(buffer, map);
                                    break;
                                case 145:
                                case 146:
                                case 193:
                                ...
                                case 249:
                                case 250:
                                    this->parseHMErrorResponse(buffer, timestamp, map.ActuatorId);
                                    break;
                                default:
...
void ILCResponseParser::parseHPErrorResponse(ModbusBuffer* buffer, int32_t subnet, int32_t dataIndex) {
    ...
    switch (exceptionCode) {
        case 1:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusIllegalFunction, true);
            break;
        case 2:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusIllegalDataAddress, true);
            break;
        case 3:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusIllegalDataValue, true);
            break;
        case 4:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusSlaveDeviceFailure, true);
            break;
        case 5:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusAcknowledge, true);
            break;
        case 6:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusSlaveDeviceBusy, true);
            break;
        case 7:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusNegativeAcknowledge, true);
            break;
        case 8:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusMemoryParityError, true);
            break;
        case 10:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusGatewayPathUnavailable, true);
            break;
        case 11:
            BitHelper::set(this->hardpointActuatorWarning->hardpointActuatorFlags + dataIndex, HardpointActuatorFlags::ModbusGatewayTargetDeviceFailedToRespond, true);
            break;
        default:
...
void ILCResponseParser::parseFAErrorResponse(ModbusBuffer* buffer, int32_t subnet, int32_t dataIndex) {
    ...
    switch (exceptionCode) {
        case 1:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusIllegalFunction, true);
            break;
        case 2:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusIllegalDataAddress, true);
            break;
        case 3:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusIllegalDataValue, true);
            break;
        case 4:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusSlaveDeviceFailure, true);
            break;
        case 5:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusAcknowledge, true);
            break;
        case 6:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusSlaveDeviceBusy, true);
            break;
        case 7:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusNegativeAcknowledge, true);
            break;
        case 8:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusMemoryParityError, true);
            break;
        case 10:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusGatewayPathUnavailable, true);
            break;
        case 11:
            BitHelper::set(this->forceActuatorWarning->forceActuatorFlags + dataIndex, ForceActuatorFlags::ModbusGatewayTargetDeviceFailedToRespond, true);
            break;
        default:
...
void ILCResponseParser::parseHMErrorResponse(ModbusBuffer* buffer, int32_t subnet, int32_t dataIndex) {
    ...
    switch (exceptionCode) {
        case 1:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusIllegalFunction, true);
            break;
        case 2:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusIllegalDataAddress, true);
            break;
        case 3:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusIllegalDataValue, true);
            break;
        case 4:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusSlaveDeviceFailure, true);
            break;
        case 5:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusAcknowledge, true);
            break;
        case 6:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusSlaveDeviceBusy, true);
            break;
        case 7:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusNegativeAcknowledge, true);
            break;
        case 8:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusMemoryParityError, true);
            break;
        case 10:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusGatewayPathUnavailable, true);
            break;
        case 11:
            BitHelper::set(this->hardpointMonitorWarning->hardpointMonitorFlags + dataIndex, HardpointMonitorFlags::ModbusGatewayTargetDeviceFailedToRespond, true);
            break;
        default:
...
void ILCResponseParser::parseElectromechanicalForceAndStatusResponse(ModbusBuffer* buffer, ILCMap map) {
    ...
    switch (map.ActuatorId) {
        case 1:
            offset = this->hardpointActuatorSettings->HP1EncoderOffset;
            break;
        case 2:
            offset = this->hardpointActuatorSettings->HP2EncoderOffset;
            break;
        case 3:
            offset = this->hardpointActuatorSettings->HP3EncoderOffset;
            break;
        case 4:
            offset = this->hardpointActuatorSettings->HP4EncoderOffset;
            break;
        case 5:
            offset = this->hardpointActuatorSettings->HP5EncoderOffset;
            break;
        case 6:
            offset = this->hardpointActuatorSettings->HP6EncoderOffset;
            break;
    }
...
void ILCResponseParser::parseDualAxisForceDemandResponse(ModbusBuffer* buffer, ILCMap map) {
    ...
    switch (this->forceActuatorPositionInfo->actuatorOrientation[dataIndex]) {
        case ForceActuatorOrientations::PositiveX:
            ForceConverter::daaPositiveXToMirror(this->forceActuatorData->primaryCylinderForces[dataIndex], this->forceActuatorData->secondaryCylinderForces[secondaryDataIndex], &x, &y, &z);
            break;
        case ForceActuatorOrientations::NegativeX:
            ForceConverter::daaNegativeXToMirror(this->forceActuatorData->primaryCylinderForces[dataIndex], this->forceActuatorData->secondaryCylinderForces[secondaryDataIndex], &x, &y, &z);
            break;
        case ForceActuatorOrientations::PositiveY:
            ForceConverter::daaPositiveYToMirror(this->forceActuatorData->primaryCylinderForces[dataIndex], this->forceActuatorData->secondaryCylinderForces[secondaryDataIndex], &x, &y, &z);
            break;
        case ForceActuatorOrientations::NegativeY:
            ForceConverter::daaNegativeYToMirror(this->forceActuatorData->primaryCylinderForces[dataIndex], this->forceActuatorData->secondaryCylinderForces[secondaryDataIndex], &x, &y, &z);
            break;
    }
    if (xIndex != -1) {
