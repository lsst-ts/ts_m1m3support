...
int32_t ExpansionFPGA::open() {
	...
	int32_t status = NiFpga_Open("/usr/ts_M1M3Support/"NiFpga_M1M3Expansion_Bitfile, NiFpga_M1M3Expansion_Signature, this->expansionFPGAApplicationSettings->Resource.c_str(), 0, &(this->session));
