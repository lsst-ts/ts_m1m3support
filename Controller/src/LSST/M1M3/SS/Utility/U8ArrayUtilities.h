...
public:
	...
	inline static int16_t I16(uint8_t* buffer, int32_t index) {
		return  ((int16_t)buffer[index] << 8) |
				(int16_t)buffer[index + 1];
	}

	inline static int32_t I32(uint8_t* buffer, int32_t index) {
		return  ((int32_t)buffer[index] << 24) |
	...
	inline static int64_t I64(uint8_t* buffer, int32_t index) {
		return  ((int64_t)buffer[index] << 54) |
				((int64_t)buffer[index + 1] << 48) |
				((int64_t)buffer[index + 2] << 40) |
				((int64_t)buffer[index + 3] << 32) |
				((int64_t)buffer[index + 4] << 24) |
				((int64_t)buffer[index + 5] << 16) |
				((int64_t)buffer[index + 6] << 8) |
				(int64_t)buffer[index + 7];
	}

	inline static uint8_t U8(uint8_t* buffer, int32_t index) {
		return buffer[index];
	}
