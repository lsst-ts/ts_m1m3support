...
DistributedForces ForceConverter::calculateForceFromAngularAcceleration(ForceActuatorSettings* forceActuatorSettings, float angularAccelerationX, float angularAccelerationY, float angularAccelerationZ) {
	...
	for(int zIndex = 0; zIndex < FA_COUNT; ++zIndex) {
		...
		forces.XForces[zIndex] =
				...
				forceActuatorSettings->AccelerationZTable[mIndex + 0] * angularAccelerationZ) / 1000.0;
		...
		forces.YForces[zIndex] =
				...
				forceActuatorSettings->AccelerationZTable[mIndex + 1] * angularAccelerationZ) / 1000.0;
		...
		forces.ZForces[zIndex] =
				...
				forceActuatorSettings->AccelerationZTable[mIndex + 2] * angularAccelerationZ) / 1000.0;
	}
...
DistributedForces ForceConverter::calculateForceFromAngularVelocity(ForceActuatorSettings* forceActuatorSettings, float angularVelocityX, float angularVelocityY, float angularVelocityZ) {
	...
	for(int zIndex = 0; zIndex < FA_COUNT; ++zIndex) {
		...
		forces.XForces[zIndex] =
				...
				forceActuatorSettings->VelocityYZTable[mIndex + 0] * angularVelocityYZ) / 1000.0;
		...
		forces.YForces[zIndex] =
				...
				forceActuatorSettings->VelocityYZTable[mIndex + 1] * angularVelocityYZ) / 1000.0;
		...
		forces.ZForces[zIndex] =
				...
				forceActuatorSettings->VelocityYZTable[mIndex + 2] * angularVelocityYZ) / 1000.0;
	}
