                ...
                if (subnet >= 1 && subnet <= 5) {
                    ...
                    switch (function) {
                        ...
                        case 231:
                            ...
                            break;
                        default:
                            Log.Error("FirmwareUpdate: Unknown function %d on subnet %d", function, subnet);
                            return false;
                    }
                    if (!ok) {
                        return false;
...
bool FirmwareUpdate::ProcessVerifyUserApplication(ModbusBuffer* buffer) {
    ...
    switch (status) {
        case 0x0000:
            return true;
        case 0x00FF:
            Log.Error("FirmwareUpdate: Application Stats Error");
            return false;
        case 0xFF00:
            Log.Error("FirmwareUpdate: Application Error");
            return false;
        case 0xFFFF:
            Log.Error("FirmwareUpdate: Application Stats and Application Error");
            return false;
        default:
            Log.Error("FirmwareUpdate: Unknown Status");
            return false;
    }
}
